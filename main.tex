...
I'm a Computational Social Scientist specializing in large-scale digital trace data to understand human behavior. 
...
I led a small team in developing a machine learning system for energy price forecasting, battery scheduling, and automated trading. This zero-to-one effort produced a platform capable of accurately predicting five distinct price outcomes and optimizing battery operations in real time. I oversaw people management, product strategy, and engineering execution. The system increased annual revenue capture for renewable and battery assets by 20–30\%.  
%
}
...
I partnered with cross-functional teams to research and measure the overall health of the Twitter platform. This work included designing and fielding large-scale surveys, applying statistical analysis, and directly informing product development (e.g., Birdwatch/Community Notes). I also productionized customer revenue models to guide key financial decisions and audited machine learning algorithms to ensure demographic and political representativeness.
}
...
{TWITTER}
{Washington, DC}
{ \jobtitle{Staff Quant User Researcher} \\
I led Twitter's internal survey efforts to understand customer attitudes around the 2020 US elections, and led similar workstreams around platform health. My team conceived and executed research using survey and digital trace data to understand people's perceptions, needs, and experiences on Twitter. I also led survey work around generative AI to inform policy about labeling this content on the site. My team built statistical tools to locate representative samples of people on Twitter.%, and when appropriate combine survey responses with behavioral data to get a more complete view of attitudes and behaviors.\\
}
%------------------------------------------------
